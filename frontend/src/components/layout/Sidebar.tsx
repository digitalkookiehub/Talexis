...
const studentNav: NavItem[] = [
  ...
  { to: '/student/jobs', label: 'Job Board', icon: <Briefcase size={20} /> },
...
const companyNav: NavItem[] = [
  ...
  { to: '/company/schedule', label: 'Schedule', icon: <ClipboardCheck size={20} /> },
  { to: '/company/analytics', label: 'Analytics', icon: <BarChart3 size={20} /> },
];

const collegeNav: NavItem[] = [
  { to: '/college', label: 'Dashboard', icon: <LayoutDashboard size={20} /> },
  { to: '/college/students', label: 'Candidate Roster', icon: <Users size={20} /> },
  { to: '/college/analytics', label: 'Analytics', icon: <BarChart3 size={20} /> },
  { to: '/college/placements', label: 'Placements', icon: <Heart size={20} /> },
];
